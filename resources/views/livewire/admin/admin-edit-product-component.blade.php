<section class="section_form">
    ...
    @endif
    <form id="consultation-form" class="feed-form pt-2 pb-5" wire:submit.prevent="updateProduct">
        ...
        <input type="file" name="image" required placeholder=" صورة لحيوانك" wire:model="newimage">
        @if ($newimage)
